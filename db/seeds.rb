...
User.create! :name => 'L.D.',    :email => 'l_damian@yahoo.com',         :password => 'topsecret', :password_confirmation => 'topsecret', :confirmation_token => 'KRvf5RyyyPVJWPdZGpWo', :confirmed_at => DateTime.now, :confirmation_sent_at => DateTime.now, :role => :admin
